...
Start by generating a new react library for components call `ghost-ai-components` using the nx monorepo syntax. For all the components created after this, add them to this library via nx.

### Editor Navbar

Create `editor/editor-navbar.tsx`.

- fixed-height top navbar
- left, centerm and right sections
...
Create `editor/project-sidebar.tsx`.
